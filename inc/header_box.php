...
<div class="header_inner">
	...
	<?php
	if ($str[1] == "") {
		echo '<h1 class="logo"><a href="/">'. SITE_NAME .'</a></h1>';
	} else {
		echo '<p class="logo"><a href="/">'. SITE_NAME .'</a></p>';
	}
	?>
	...
	<nav class="nav">
		<ul class="nav__list">
			...
			<li class="nav__item sp"><a href="/" class="nav__link" <?php if ($str[1] == "") {
															echo ' class="here"';
														} ?>><img src="/images/common/triangle_icon.png" alt="">利用規約</a></li>
			<li class="nav__item sp"><a href="/" class="nav__link" <?php if ($str[1] == "") {
															echo ' class="here"';
														} ?>><img src="/images/common/triangle_icon.png" alt="">お問合せ</a></li>
			<li class="nav__item sp"><a href="/" class="nav__link" <?php if ($str[1] == "") {
															echo ' class="here"';
														} ?>><img src="/images/common/nav_sp_img_1.png" alt=""></a></li>
			<li class="nav__item sp"><a href="/" class="nav__link" <?php if ($str[1] == "") {
															echo ' class="here"';
														} ?>><img src="/images/common/nav_sp_img_2.svg" alt=""></a></li>
		</ul>
	</nav>
