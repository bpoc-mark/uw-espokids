        ...
        <div class="container">
            <nav>
                <ul>
                    ...
                    <li><a href="/sitemap">料金について</a></li>
                    <li><a href="/privacy">施設&アクセス</a></li>
                    <li><a href="/privacy">料金シュミレーション</a></li>
                </ul>
            </nav>
            <div class="row">
                <div class="col">
                ...
                <div class="col">
                    <div class="col-icons">
                        <picture>
                            ...
                            <img class="icon-1" src="/images/common/footer_icon-2.svg" alt="">
                        </picture>

                        <img class="icon-2" src="/images/common/footer_icon-1.svg" alt="">
                    </div>
                </div>
            </div>
        </div>
